...
namespace XafGitHubCopilot.Blazor.Server.Controllers
{
    /// <summary>
    ...
    /// AI tool calls run on background threads (Copilot SDK), so we capture the
    ...
    {
        private const string AiFilterKey = "AICopilotFilter";
