...
namespace XafGitHubCopilot.Blazor.Server
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                builder.UseApplication<XafGitHubCopilotBlazorApplication>();
                builder.Modules
                    .AddCloning()
                    ...
                    .Add<XafGitHubCopilotBlazorModule>();
                builder.ObjectSpaceProviders
                    .AddSecuredEFCore(options =>
                    {
                        options.PreFetchReferenceProperties();
                    })
                    .WithDbContext<XafGitHubCopilot.Module.BusinessObjects.XafGitHubCopilotEFCoreDbContext>((serviceProvider, options) =>
                    {
